...
export const ArticleActions = ({ publishDate, _id, allLikes, link }: any) => {
  ...
  return (
    <div className="border-solid my-1 flex justify-end  items-center">
      <div className="flex items-center">
        <div className="flex-auto flex items-center mr-5">
